...
const MoonIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    <path fillRule="evenodd" clipRule="evenodd"
      d="M9.14 1.07C5.05 1.62 1.9 9.33c0 4.6 3.73 8.33 8.33 8.33 3.84 0 7.08-2.6 8.07-6.16-.8.26-1.65.4-2.54.4-4.6 0-8.33-3.73-8.33-8.33 0-.17 0-.34.01-.5z"
      fill="#858BB2" />
  </svg>
)

const Avatar = () => (
 <img src={avatarImg} alt="User profile" className="w-10 h-10 rounded-full object-cover border-2 border-transparent hover:border-purple-light transition-colors cursor-pointer" />
)
      ...
      >
        ...
        <div className="flex items-center h-full">
          ...
          <div className="px-6 h-full flex items-center justify-center">
            <div className="w-8 h-8 rounded-full bg-[#7E88C3] flex items-center justify-center border-2 border-transparent hover:border-purple-light transition-colors cursor-pointer overflow-hidden">
