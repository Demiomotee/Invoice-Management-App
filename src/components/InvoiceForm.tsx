...
const inp = (err: boolean) =>
  `w-full px-5 py-4 rounded-[4px] bg-white dark:bg-dark-2 border text-[13px] font-bold text-dark-1 dark:text-white transition-colors outline-none
  ${err ? 'border-[#EC5757] focus:border-[#EC5757]' : 'border-gray-1 dark:border-dark-3 hover:border-purple focus:border-purple'}`
